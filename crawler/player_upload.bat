...
for /f "tokens=*" %%A in (.\player_jsons\filenames.txt) do mongoimport --uri mongodb+srv://%uname%:!pass!@nsp-cluster-zqniz.mongodb.net/Players --collection %%B --type json --file player_jsons\%%B\%%A
